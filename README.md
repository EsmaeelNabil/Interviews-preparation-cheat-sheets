...
## 🗺️ Study Areas Overview

<details open>
<summary><strong>Click to expand: Interactive Study Roadmap</strong></summary>
...
|:----------|:--------------|:------|
| **[🏛️ kotlin/](kotlin/)** | Kotlin language, coroutines, data structures | 3 files + README |
| **[🏗️ architecture/](architecture/)** | Clean Architecture, DI, Design Patterns | 3 files + README |
...
| **[⚡ performance/](performance/)** | Memory, Battery, Optimization | 3 files + README |
